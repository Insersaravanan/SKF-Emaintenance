...
CREATE Procedure [dbo].[SP_MachineCreateAndData updated Successfully]
(
...
CREATE Procedure [dbo].[SP_MachineDriveAssetCreateAndData updated Successfully]
(
@ClientID nvarchar(50)=NULL,
@MachineID nvarchar(250)=NULL,
@UserID nvarchar(50)=NULL,
...
CREATE Procedure [dbo].[SP_MachineIntermediateAssetCreateAndData updated Successfully]
(
@ClientID nvarchar(50)=NULL,
@MachineID nvarchar(250)=NULL,
@UserID nvarchar(50)=NULL,
...
CREATE Procedure [dbo].[SP_MachineDrivenEndAssetCreateAndData updated Successfully]
(
@ClientID nvarchar(50)=NULL,
@MachineID nvarchar(250)=NULL,
@UserID nvarchar(50)=NULL,
