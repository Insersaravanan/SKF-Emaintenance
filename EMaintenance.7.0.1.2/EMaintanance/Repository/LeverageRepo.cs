...
namespace EMaintanance.Repository
{
    public class LeverageRepo
    {
        ...
        public async Task<IEnumerable<dynamic>> GetLeverage(DateTime? FromDate, DateTime? ToDate, int LanguageId, int ClientSiteId)
        {
            ...
            using (var conn = util.MasterCon())
            {
                try
                {
                    return await conn.QueryAsync<dynamic>(sql, new { FromDate, ToDate, LanguageId, ClientSiteId }, commandType: CommandType.StoredProcedure);
                }
                catch (Exception ex)
                {
        ...
        public async Task<IEnumerable<dynamic>> GetLeverageByCustomerID(DateTime? FromDate, DateTime? ToDate, int LanguageId, int ClientSiteId)
        {
            string sql = "dbo.EAppListLeverageServiceByCustomerID";
            using (var conn = util.MasterCon())
            {
                try
                {
