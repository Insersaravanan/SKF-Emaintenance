...
namespace EMaintanance.Repository
{
    public class ObserverDashboardRepo
    {
        ...
        public async Task<IEnumerable<dynamic>> GetDashboardGoogleMapDetails([FromBody] ObserverDashboardViewModel obdvm)
        {
            string sql = "dbo.OAppListAssetStatusGoogleMap2";
            using (var conn = util.MasterCon())
            {
                try
                {
