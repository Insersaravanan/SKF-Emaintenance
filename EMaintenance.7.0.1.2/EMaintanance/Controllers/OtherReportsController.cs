...
namespace EMaintanance.Controllers
{
    ...
    public class OtherReportsController : Controller
    {
        ...
        public async Task<IActionResult> GetEquipmentByAssetLists(int lId, int eId, int csId, int rId, string type, string at, string status)
        {
            CurrentUser cUser = new CurrentUser(HttpContext, _configuration);
            try
            {

                var result = await otherReportsRepo.GetEquipmentByAssetLists(lId, eId, csId, rId, type, at, status);
