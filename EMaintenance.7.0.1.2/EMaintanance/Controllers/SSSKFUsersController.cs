...
namespace EMaintanance.Controllers
{
    //[SKFAuthorize("PRG02")]
    [Authorize]
    public class SSSKFUsersController : Controller
    {
        private readonly SSSKFUsersRepo uRepo;
        private readonly UserManager<IdentityUser> _identityManager;
        private IConfiguration _configuration;
        public SSSKFUsersController(IConfiguration configuration, UserManager<IdentityUser> identityManager)
        {
            uRepo = new SSSKFUsersRepo(configuration);
