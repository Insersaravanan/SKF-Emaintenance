...
namespace EMaintanance.Controllers
{
    //[SKFAuthorize("PRG02")]
    [Authorize]
    public class SSDistributorUsersController : Controller
    {
        private readonly SSDistributorUsersRepo uRepo;
        private readonly UserManager<IdentityUser> _identityManager;
        private IConfiguration _configuration;
        public SSDistributorUsersController(IConfiguration configuration, UserManager<IdentityUser> identityManager)
        {
            uRepo = new SSDistributorUsersRepo(configuration);
