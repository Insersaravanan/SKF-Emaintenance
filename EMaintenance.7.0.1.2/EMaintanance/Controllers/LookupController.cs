...
namespace EMaintanance.Controllers
{
    ...
    public class LookupController : Controller
    {
        ...
        public async Task<IActionResult> GetProgramTypeByClientID(int lId, int csId, string lName)
        {
            try
            {
                return Ok(await lookupRepo.GetProgramTypeByClientID(lId, csId, lName));
            }
            catch (CustomException cex)
            {
                var responseObj = new EmaintenanceMessage(cex.Message, cex.Type, cex.IsException, cex.Exception?.ToString());
        ...
        [HttpGet]
        public async Task<IActionResult> GetLookupByNameAndType(int lId, string lName, string AType)
        {
            try
            {
                return Ok(await lookupRepo.GetLookupByNameAndType(lId, lName, AType));
            }
            catch (CustomException cex)
            {
                var responseObj = new EmaintenanceMessage(cex.Message, cex.Type, cex.IsException, cex.Exception?.ToString());
