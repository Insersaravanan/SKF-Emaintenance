...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory,$translate,$rootScope, alertFactory,$timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'FailureCauseCode', displayName: 'Failure Cause Code', headerCellFilter: 'translate',cellClass: getCellClass,enableColumnResizing: true, width: "17%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'FailureCauseName', displayName: 'Failure Cause Name', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "24%", minWidth: 150 },
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditFailureCause"|translate}} tooltip-class="customClass"></i></a>' +
                ...
                '<a ng-click="grid.appScope.FmodeCause(row.entity)" <i class="fa fa-link icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"FailureCause-FailureModeRelation"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "9%",
            minWidth: 100
        }
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory,$timeout) {
    ...
    var _columns = [
        ...
        { name: 'FailureCauseName', displayName: 'Failure Cause Name', headerCellFilter: 'translate',enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
...
app.controller('skfFailureCauseModeModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory,$timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'FailureModeName', displayName: 'Failure Mode Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,minWidth: 150
        },
        {
            name: 'Active', displayName: 'Active', headerCellFilter: 'translate', enableFiltering: false,
