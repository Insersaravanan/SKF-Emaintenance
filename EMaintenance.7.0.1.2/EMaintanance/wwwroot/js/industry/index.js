...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory,$rootScope,$translate, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'SectorName', displayName: 'Sector Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "16%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'SegmentName', displayName: 'Segment Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 150

        },
        { name: 'IndustryCode', displayName: 'Industry Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "7%", minWidth: 100 },
        { name: 'IndustryName', displayName: 'Industry Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "13%", minWidth: 150 },
        { name: 'DownTimeCostPerHour', displayName: 'DownTime Cost PerHour', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "11%", minWidth: 150 },
        { name: 'Descriptions', displayName: 'Descriptions', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "13%", minWidth: 200 },
        {
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditIndustry"|translate}} tooltip-class="customClass"></i></a>' +
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory,$timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'IndustryCode', displayName: 'Industry Code',
            headerCellFilter: 'translate',enableColumnResizing: true, enableCellEdit: false, enableFiltering: false, minWidth: 150 },
        {
            name: 'IndustryName', displayName: 'Industry Name',
            headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
        {
            name: 'Descriptions', displayName: 'Descriptions',
            headerCellFilter: 'translate',
            enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 200
        }
    ];
