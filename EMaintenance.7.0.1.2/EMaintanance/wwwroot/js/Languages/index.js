...
app.controller('skfCtrl', function ($scope, $filter, $timeout, uiGridConstants, $translate, $rootScope, $http, languageFactory, alertFactory) {
    $scope.startIndex = 1;
    $scope.isCreate = true;
    $scope.isEdit = false;
    $scope.isclear = true;
    ...
    var _columns = [
        ...
        {
            name: 'LName', displayName: 'Language Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "25%", minWidth: 200, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'CountryCode', displayName: 'Country Code', headerCellFilter: 'translate', width: '25%', minWidth: 200,cellClass: getCellClass,
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Edit Language"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>'
        }
    ];
