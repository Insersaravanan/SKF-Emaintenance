...
app.controller('skfCtrl', function ($scope, $filter, $translate, $rootScope, uiGridConstants, $http, $uibModal, languageFactory, apiFactory, alertFactory, $timeout) {
    $scope.startIndex = 1;
    ...
    var _columns = [
        ...
        {
            name: 'ProgramCode', displayName: 'Program Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{Total Count|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'ProgramName', pinnedLeft: true, displayName: 'Program Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "8%", minWidth: 150 },
        { name: 'MenuOrder', type: 'number', displayName: 'Menu Order', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "8%", minWidth: 80 },
        { name: 'ControllerName', displayName: 'Controller Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "8%", minWidth: 150 },
        { name: 'GroupCode', displayName: 'Group Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "15%", minWidth: 150 },
        { name: 'MenuGroupName', displayName: 'Menu Group', headerCellFilter: 'translate',cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 150 },
        { name: 'MenuName', displayName: 'Menu Name', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "10%", minWidth: 150 },
        { name: 'SubgroupCode', displayName: 'Sub-Group Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 150 },
        { name: 'Descriptions', displayName: 'Description', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 150 },
        { name: 'IconName', displayName: 'Icon Name', headerCellFilter: 'translate',cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 150 },
        { name: 'LinkUrl', displayName: 'Link Url', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 150 },
        { name: 'ActionName', displayName: 'Action Name', headerCellFilter: 'translate',cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 150 },
        {
            name: 'Active', displayName: 'Active', headerCellFilter: 'translate', displayName: 'Status',cellClass: getCellClass,
        ...
        {
            name: 'Action', displayName: 'Action', enableFiltering: false, enableSorting: false,cellClass: getCellClass,
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Edit Program"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.multiLanguage(row.entity)" <i class="fa fa-language icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Multi Language"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.ProgramPrivilegeRel(row.entity)" <i class="fa fa-link icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Program Privilege Relation"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "9%",
            minWidth: 100
        }
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'LanguageName', displayName: 'Language ', headerCellFilter: 'translate', enableCellEdit: false, 
        ...
        { name: 'ProgramName', displayName: 'Program Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
        { name: 'MenuName', displayName: 'Menu Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
        { name: 'Descriptions', displayName: 'Descriptions', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 }
