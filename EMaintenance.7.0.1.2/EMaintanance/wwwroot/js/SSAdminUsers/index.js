...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, uiGridPinningConstants, $uibModal, $translate, $rootScope, $timeout, $http, languageFactory, alertFactory) {
    $scope.startIndex = 1;
    $scope.isEdit = false;
    ...
    var _columns = [
        ...
        {
            name: 'UserName', displayName: 'User Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "25%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >  {{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'FirstName', displayName: 'First Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "15%", minWidth: 150 },
        { name: 'LastName', displayName: 'Last Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "15%", minWidth: 150 },
        { name: 'Mobile', displayName: 'Mobile', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 100 },
        { name: 'EmailId', displayName: 'Email', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "20%", minWidth: 150 },
        {
