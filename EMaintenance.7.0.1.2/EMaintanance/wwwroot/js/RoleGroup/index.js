...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $translate, $rootScope, $uibModal, languageFactory, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'RoleGroupName', displayName: 'Role Group Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "30%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditRoleGroup"|translate}} tooltip-class="customClass"></i></a>' +
                ...
                '<a ng-click="grid.appScope.roleGroupRelation(row.entity)" <i class="fa fa-link icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"RoleGroup-RoleRelation"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "15%",
            minWidth: 100
        }
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns= [
        ...
        { name: 'RoleGroupName', displayName: 'Role Group Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
