...
app.controller('skfCtrl', function ($scope, $filter, $window, $timeout, $http, $uibModal, uiGridConstants, utility, clientFactory, $rootScope, $translate, languageFactory) {

    $scope.columns = [
        { name: 'sno', displayName: '#', width: "50", enablePinning: false, enableCellEdit: false, cellClass: getCellClass, enableFiltering: false },
        { name: 'PlantAreaName', displayName: 'PlantArea Name', headerCellFilter: 'translate', width: '10%', enableCellEdit: false, cellClass: getCellClass },
        { name: 'AreaName', displayName: 'Area Name', headerCellFilter: 'translate', width: '9%', enableCellEdit: false, cellClass: getCellClass },
        { name: 'SystemName', displayName: 'System Name', headerCellFilter: 'translate', width: '9%', enableCellEdit: false, cellClass: getCellClass },
        { name: 'JobNumber', displayName: 'Job No', headerCellFilter: 'translate', enableColumnResizing: true, width: '7%', enableCellEdit: false, cellClass: getCellClass },
        { name: 'JobName', displayName: 'Job Name', headerCellFilter: 'translate', enableColumnResizing: true, width: '16%', enableCellEdit: false, cellClass: getCellClass },
        { name: 'EquipmentName', displayName: 'Equipment Name', headerCellFilter: 'translate', width: '12%', enableCellEdit: false, cellClass: getCellClass },
        {
            name: 'VA', displayName: 'VA', headerCellFilter: 'translate', enableColumnResizing: true, width: '6%', type: 'boolean', enableCellEdit: false, cellClass: getCellClass,
        ...
        {
            name: 'OA', displayName: 'OA', headerCellFilter: 'translate', enableColumnResizing: true, width: '6%', type: 'boolean', enablePinning: false, enableCellEdit: false, cellClass: getCellClass,
        ...
        {
            name: 'ReportDate', displayName: 'Report Date', headerCellFilter: 'translate', enableColumnResizing: true, width: '10%', enableCellEdit: false, cellClass: getCellClass,
            cellTemplate: '<div class="ui-grid-cell-contents">{{row.entity.ReportDate | date:\'dd/MM/yyyy\' }}</div>'
        },
        {
            name: 'DataCollectionDate', displayName: 'Data Collection Date', headerCellFilter: 'translate', width: '12%', enableCellEdit: false, cellClass: getCellClass,
