var app = angular.module('skfApp', ['ngAnimate', 'angular-loading-bar', 'ui.bootstrap', 'angular.filter', 'angularjs-dropdown-multiselect', 'angularjs-gauge', 'pascalprecht.translate']);
