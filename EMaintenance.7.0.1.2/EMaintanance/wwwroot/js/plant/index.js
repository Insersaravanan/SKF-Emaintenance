...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, $translate, $rootScope, $window, languageFactory, alertFactory, clientFactory, $timeout, i18nService) {
    $scope.startIndex = 1;
    //$scope.isEdit = false;
    ...
    var _columns = [
        ...
        //},
        {
            name: 'PlantAreaName', displayName: 'Plant Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "30%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'Descriptions', displayName: 'Descriptions', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "32%", minWidth: 100 },
        {
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditPlant"|translate}} tooltip-class="customClass"></i></a>' +
                ...
                '<a ng-click="grid.appScope.clone(row,\'PL\')"><i class="fa fa-clone icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"CloneUnit"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "15%",
            minWidth: 100
        }
    ...
    $scope.$watch(function () {
        ...
        if (newValue != oldValue && newValue) {
            ...
            console.log($scope.language.CountryCode);
            i18nService.setCurrentLang($scope.language.CountryCode);
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'PlantAreaName', displayName: 'Plant Area Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
