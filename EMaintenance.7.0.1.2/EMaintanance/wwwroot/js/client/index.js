...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, $rootScope, $translate,$window, languageFactory, alertFactory, $timeout) {
    $scope.startIndex = 1;
    //$scope.isEdit = false;
    ...
    var _columns = [
        ...
        {
            name: 'ClientName', displayName: 'Client Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "50%", minWidth: 200, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'ClientStatusName', displayName: 'Status', headerCellFilter: 'translate', cellClass: getCellClass,
            width: "15%",
            minWidth: 100
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity) || grid.appScope.toggleCreate()" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditClient"|translate}} tooltip-class="customClass"></i></a>' +
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'ClientName', displayName: 'Client Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 }
    ];
