...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory,$translate,$rootScope, alertFactory, $timeout) {
    $scope.startIndex = 1;
    $scope.isEdit = false;
    ...
    var _columns = [
        ...
        {
            name: 'SectorName', displayName: 'Sector', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "10%", minWidth: 150, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'SegmentName', displayName: 'Segment', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 120 },
        { name: 'IndustryName', displayName: 'Industry', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 120 },
        { name: 'AssetClassTypeCode', displayName: 'Asset Class Type Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "15%", minWidth: 140 },
        { name: 'TaxonomyCode', displayName: 'Taxonomy Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 120 },
        { name: 'AssetCategoryName', displayName: 'Asset Category', headerCellFilter: 'translate',cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 120 },
        { name: 'AssetClassName', displayName: 'Asset Class', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "12%", minWidth: 120 },
        { name: 'AssetTypeName', displayName: 'Asset Type', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 120 },
        { name: 'AssetSequenceName', displayName: 'Asset Sequence',headerCellFilter:'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 120 },
        //{ name: 'AssetTypeName', displayName: 'Asset Type', enableColumnResizing: true, width: "12%", minWidth: 120 },
        //{ name: 'FailureModeName', displayName: 'Failure Mode', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 120 },                                                                                                                                                                                                                                                                                    
        //{ name: 'FailureCauseName', displayName: 'Failure Cause', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 120 },
        ...
        { name: 'MTBF', displayName: 'MTBF(Years)', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 50 },
        { name: 'MTTR', displayName: 'MTTR(Hours)', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 50 },
        {            
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditTaxonomy"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "9%",
            minWidth: 100
        }
