...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $rootScope, $translate, $uibModal, languageFactory, alertFactory, $timeout, clientFactory) {
    $scope.startIndex = 1;
    $scope.isEdit = false;
    ...
    $scope.loadlegends = function () {
        var _url = "/Lookup/GetLookupByName?lId=" + $scope.language.LanguageId + "&lName=ReportStatusLegend";
        $http.get(_url)
    ...
    var _columns = [
        ...
        {
            name: 'JobNumber', displayName: 'Job #', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "5%", minWidth: 60, cellClass: getCellClass, aggregationHideLabel: false

        },
        {
            name: 'JobName', displayName: 'Job Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "18%", minWidth: 140, cellClass: getCellClass, aggregationType: uiGridConstants.aggregationTypes.count,
        ...
        { name: 'EstStartDate', displayName: 'Est. Start Date', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 70, width: "9%", cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        { name: 'EstEndDate', displayName: 'Est. End Date', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 70, width: "9%", cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        {
            ...
            headerCellTemplate: '<span class="report-header">{{"Vibration Analysis"|translate}}<span class="common-report-heading job-list">{{"Job Services"|translate}}</span></span>',
        ...
        },
        {
            ...
            headerCellTemplate: '<span class="report-header">{{"Oil Analysis"|translate}}</span>',
        ...
        {
            name: 'StatusName', displayName: 'Job Status', headerCellFilter: 'translate', cellClass: getCellClass, enableCellEdit: false,
            width: "9%",
            minWidth: 120,
        ...
        {
            name: 'StatusPercent', displayName: 'Job Progress', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "8%", minWidth: 100, cellClass: getCellClass,
        ...
        {
            name: 'Assignment',
            displayName: 'Planning', headerCellFilter: 'translate',
        ...
        {
            name: 'Active', displayName: 'Select', headerCellFilter: 'translate', enableFiltering: false, cellClass: getCellClass,
            headerCellTemplate: '<div class="ui-grid-cell-contents job-user">' +
                '<span>{{"Select"|translate}} &nbsp;&nbsp</span><div><input type="checkbox" class="header-checkbox" ng-click="grid.appScope.SelectAll()" ng-true-value="\'Y\'" ng-false-value="\'N\'"></div>' +
            ...
            type: 'boolean', cellTemplate: '<div class="ui-grid-cell-contents grid-checkbox"><input type="checkbox" ng-disabled="row.entity.StatusCode == \'C\'" ng-model="row.entity.Assigned"  tooltip-append-to-body="true" uib-tooltip={{"Selectjobtoassignuser"|translate}} tooltip-class="customClass" ng-click="grid.appScope.selectUser(row.entity)" ng-true-value="\'Y\'" ng-false-value="\'N\'"></div>',
            width: "6%",
            minWidth: 50
        },
        {
            name: 'Action', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false, enableSorting: false, enableCellEdit: false, cellClass: getCellClass,
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" ng-class="{disable: row.entity.StatusCode != \'NS\'}" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditJobList"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.splitJob(row.entity)" ng-class="{disable: row.entity.AnalystId == \'0\' || row.entity.StatusCode == \'C\'}"><i class="fa fa-cut icon-space-before"  tooltip-append-to-body="true" uib-tooltip={{"SplitJob"|translate}} tooltip-class="customClass"></i></a>' +
                '<a href="/ReportFeeder" ng-class="{disable: row.entity.Assignment != \'Done\'}"><i class="fa fa-file-text icon-space-before"  tooltip-append-to-body="true" uib-tooltip={{"CreateReport"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.Report(row)" ng-class="{disable:row.entity.StatusCode == \'NS\'}"><i class="fa fa-align-left icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"SummaryReport"|translate}} tooltip-class="customClass import-tooltip"></i></a>' +
                '</div>',
            width: "11%",
            minWidth: 100
        }
    ...
    $scope.loadProgramType = function () {
       ...
       $scope.ProgramTypeDDL = [];
        ...
        var _url = "/Lookup/GetProgramTypeByClientID?lId=" + $scope.language.LanguageId + "&csId=" + $scope.ClientSiteId + "&lName=ProgramType";
        $http.get(_url)
            .then(function (response) {
                $scope.ProgramTypeDDL = response.data;
                $scope.ProgramTypeDDL.splice(0, 0, $scope.defaultProgramType);
                angular.forEach(response.data, function (val, i) {
                    if (val.LValue === "--Select--") {
                        $scope.Job.ProgramTypeId = val.LookupId;
                    }
                });
            });
    };
...
app.controller('skfPlantModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'PlantAreaName', displayName: 'Plant Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
        ...
        {
            name: 'SystemName', displayName: 'System Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
        ...
        {
            name: 'Active', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false,
            //filter: {
            //    type: uiGridConstants.filter.SELECT,
            //    selectOptions: [{ value: 'Y', label: 'Selected' }, { value: 'N', label: 'Unselected' }]
            //},
            headerCellTemplate: '<label class="ui-grid-cell-contents"><span>{{"Select All"|translate}} &nbsp;&nbsp</span><input type="checkbox" class="header-checkbox" ng-disabled="grid.appScope.isView" ng-click="grid.appScope.SelectAll()" ng-true-value="\'Y\'" ng-false-value="\'N\'"></label>',
    ...
    $scope.loadMachine = function () {
        if ($scope.isEdit || $scope.isView) {
            ...
            var _url = "Equipment/GetEquipmentsByClientSite?csId=" + $scope.csId + "&lId=" + $scope.languageId + "&status=ALL"
            $http.get(_url)
                .then(function (response) {
                    $scope.gridOpts.data = response.data;
                    angular.forEach($scope.SelectedRow, function (data, i) {
...
app.controller('skfAssignEqPopupModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'PlantName', displayName: 'Plant', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'AreaName', displayName: 'Area', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'SystemName', displayName: 'System', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'EquipmentName', displayName: 'Equipment', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'ServiceName', displayName: 'Service', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'DataCollectorName', displayName: 'DataCollector', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'AnalystName', displayName: 'Analyst', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },

        {
            name: 'ReviewerName', displayName: 'Reviewer', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'Active', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false,
            headerCellTemplate: '<label class="ui-grid-cell-contents"><span>{{"Select All"|translate}} &nbsp;&nbsp</span><input type="checkbox" class="header-checkbox" ng-click="grid.appScope.SelectAll()" ng-true-value="\'Y\'" ng-false-value="\'N\'"></label>',
