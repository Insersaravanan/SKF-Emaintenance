...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory,$translate,$rootScope, alertFactory, $timeout, clientFactory) {
    $scope.startIndex = 1;
    $scope.isEdit = false;
    ...
    var _columns = [
        ...
        {
            name: 'PlantAreaName', displayName: 'Plant', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "15%", minWidth: 100, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'EquipmentName', displayName: 'Equipment Name', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "15%", minWidth: 100

        },
        {
            name: 'ReportDate', displayName: 'Report Date', headerCellFilter: 'translate', enableColumnResizing: true, width: "12%", minWidth: 100, cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass

        },
        {
            name: 'RecommendationDate', displayName: 'Recommendation Date', headerCellFilter: 'translate', enableColumnResizing: true, width: "12%", minWidth: 100, cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass

        },
        { name: 'Recommendation', displayName: 'Recommendation', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "15%", minWidth: 100 },
        { name: 'Saving', displayName: 'Saving', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "6%", minWidth: 100 },
        {
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                ...
                '<a href="{{row.entity.PhysicalPath}}" target="_blank"><i class="fa fa-download icon-space-before" tooltip-append-to-body="true" uib-tooltip={"DownloadFile"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "10%",
            minWidth: 100
        }
