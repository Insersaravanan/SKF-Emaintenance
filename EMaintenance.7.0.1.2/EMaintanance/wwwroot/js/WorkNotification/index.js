...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal,$rootScope,$translate,languageFactory, alertFactory, clientFactory, $timeout) {
    $scope.startIndex = 1;
    ...
    var _column = [
        ...
        {
            name: 'JobNumber', displayName: 'Job Number', headerCellFilter: 'translate',enableColumnResizing: true, enableCellEdit: false, width: "12%", minWidth: 100, cellClass: getCellClass, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'WorkNotificationNumber', displayName: 'Work Notification Number', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "15%", minWidth: 100, cellClass: getCellClass },
        { name: 'PlantAreaName', displayName: 'Plant Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 80, width: "12%", cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        { name: 'EquipmentName', displayName: 'Equipment Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 80, width: "12%", cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        { name: 'ConditionName', displayName: 'Equipment Condition Code', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 100, width: "15%", cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        {
            name: 'DataCollectionDate', displayName: 'Date', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 100, cellFilter: 'date:\'dd/MM/yyyy\''
        },
        {
            name: 'StatusName', displayName: 'Status', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "8%", minWidth: 100, cellClass: getCellClass,
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.loadAssetByEq(row.entity)"<i class="fa fa-compass icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Asset"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.Status(row.entity)" ng-class="{disable:row.entity.StatusCode == \'CL\'}"><i class="fa fa-sun-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Status"|translate}} tooltip-class="customClass"></i></a>' +
    ...
    $scope.columns1 = [
        ...
        {
            name: 'AssetName', displayName: 'Asset Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, enableCellEdit: false, width: "8%", minWidth: 100, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'UnitType', displayName: 'Unit Type', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, enableCellEdit: false, width: "8%", minWidth: 100,
        },
        {
            name: 'MeanRepairManHours', displayName: 'Total Outage Time(hrs)', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, enableCellEdit: false, width: "10%", minWidth: 100
        },
        {
            name: 'DownTimeCostPerHour', displayName: 'Down Time Cost $', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, enableCellEdit: false, width: "10%", minWidth: 100
        },
        {
            name: 'CostToRepair', displayName: 'Cost of Repair $', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, enableCellEdit: false, width: "10%", minWidth: 100
        },
        {
            name: 'StatusName', displayName: 'Status', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, enableCellEdit: false, width: "6%", minWidth: 200
        },
        {
            name: 'ActualRepairCost', displayName: 'Repair Cost', headerCellFilter: 'translate', enableColumnResizing: true, width: "10%", minWidth: 100, cellClass: getCellClass,
        ...
        {
            name: 'ActualOutageHours', displayName: 'Actual Outage', headerCellFilter: 'translate', enableColumnResizing: true, width: "10%", minWidth: 100, cellClass: getCellClass,
            cellEditableCondition: function ($scope1) {
                return ($scope1.row.entity.StatusCode == 'OP') ? true : false;
            },
        ...
        {
            name: 'Status', displayName:'Select', headerCellFilter: 'translate', enableFiltering: false, cellClass: getCellClass,
            ...
            type: 'boolean', cellTemplate: '<div class="ui-grid-cell-contents grid-checkbox"><input type="checkbox" ng-disabled="row.entity.StatusCode != \'OP\'" ng-model="row.entity.Status"  tooltip-append-to-body="true" uib-tooltip={{"CancelWn"|translate}} msgtooltip-class="customClass" ng-click="grid.appScope.selectUser(row.entity)" ng-true-value="\'Y\'" ng-false-value="\'N\'"></div>',
            width: "7%",
            minWidth: 50
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.AssetDetails(row.entity)"<i class="fa fa-info icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"View"|translate}} tooltip-class="customClass"></i></a>' +
