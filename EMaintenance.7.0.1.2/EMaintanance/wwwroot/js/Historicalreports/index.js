...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory, alertFactory, clientFactory, $timeout) {
    ...
    $scope.HistoryData = function () {
        ...
        $scope.O_HistoricalReportList.ScheduleServices = $scope.reportingDDL;
       // $scope.ObserverNodeId = $scope.O_HistoricalReportList.ScheduleServices.ObserverNodeId.
       //console.log($scope.reportingDDL);
        
        $scope.O_HistoricalReportList.ObserverNodeId = $scope.reportingDDL;
       // console.log($scope.O_HistoricalReportList.ScheduleServices);
        //console.log(JSON.stringify($scope.O_HistoricalReportList.ScheduleServices));
        
        $scope.ObserverNodeId = JSON.stringify($scope.O_HistoricalReportList.ObserverNodeId);

        //var Result = $scope.ObserverNodeId;
      ...
      //  var Result1 = $scope.ObserverNodeId;
      ////  var Result2 = $scope.ObserverNodeId.Active;
      ////  var Result3 = $scope.ObserverNodeId.SensorSelectId;
      //  var dataPoints = [];
      //  var dataPointsnew = [];
      //  var dataPointsNew1 = [];
      //  var dataPointsNew2 = [];
      //  for (var i = 0; i <= Result1.length - 1; i++) {
      //      var series = new Array(dataPoints.push({ x: Result1[i].ObserverNodeId + '-' + Result[i].Active, y: Result[i].SensorSelectId }));
      //  }
