...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $rootScope, $translate, $uibModal, languageFactory, alertFactory, $timeout, clientFactory) {
    ...
    var _columns = [
        ...
        {
            name: 'ScheduleName', displayName: 'Job Name', headerCellFilter: 'translate', enableColumnResizing: true, width: "24%", minWidth: 150, cellClass: getCellClass, aggregationType: uiGridConstants.aggregationTypes.count,
        ...
        { name: 'StartDate', displayName: 'StartDate', headerCellFilter: 'translate', enableColumnResizing: true, width: "8%", minWidth: 100, cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        { name: 'EndDate', displayName: 'EndDate', headerCellFilter: 'translate', enableColumnResizing: true, width: "8%", minWidth: 100, cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        { name: 'ProgramTypeName', displayName: 'Program Type', headerCellFilter: 'translate', enableColumnResizing: true, width: "24%", minWidth: 200,cellClass: getCellClass },
        { name: 'IntervalDays', displayName: 'Interval', headerCellFilter: 'translate', enableColumnResizing: true, width: "8%", minWidth: 60, cellClass: getCellClass },
        {
            name: 'StatusName', displayName: 'Status', headerCellFilter: 'translate', cellClass: getCellClass,
            width: "10%",
            minWidth: 100
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" ng-class="{disable: row.entity.StatusCode == \'JG\'}" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditSchedule"|translate}} tooltip-class="customClass"></i></a>' +
                ...
                '<a ng-click="grid.appScope.GenerateJob(row.entity)" ng-class="{disable: row.entity.StatusCode == \'JG\'}" ><i class="fa fa-external-link  icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"GenerateJobSchedule"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "15%",
            minWidth: 100
        }
...
app.controller('skfPlantModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        },
        {
            ...
            //},
            headerCellTemplate: '<label class="ui-grid-cell-contents"><span>{{"SelectAll"|translate}} &nbsp;&nbsp</span><input type="checkbox" ng-disabled="grid.appScope.isView" class="header-checkbox" ng-click="grid.appScope.SelectAll()" ng-true-value="\'Y\'" ng-false-value="\'N\'"></label>',
