...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $uibModal, $rootScope, $translate, $http, languageFactory, alertFactory,$timeout) {
    $scope.startIndex = 1;
    $scope.isEdit = false;
    $scope.isclear = true;
    ...
    var _columns = [
        ...
        {
            name: 'CountryName', displayName: 'Country Name', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "18%", minWidth: 200, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'CostCentreCode', displayName: 'Branch Code', headerCellFilter: 'translate',cellClass: getCellClass,enableColumnResizing: true, width: "10%", minWidth: 150 },
        { name: 'CostCentreName', displayName: 'Branch Name', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "21%", minWidth: 150 },
        { name: 'Descriptions', displayName: 'Descriptions', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "20%", minWidth: 150 },
        {
...
app.controller('skfModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'CostCentreName', displayName: 'Branch Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false }
