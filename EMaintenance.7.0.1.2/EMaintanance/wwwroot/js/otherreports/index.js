...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $rootScope, $translate, $uibModal, languageFactory, alertFactory, clientFactory, $timeout) {
    ...
    var _columns = [
        ...
        //},
        {
            name: 'FileName', displayName: 'File Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "25%", minWidth: 100, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'ReportDate', displayName: 'Report Date', headerCellFilter: 'translate', enableColumnResizing: true, width: "18%", minWidth: 100, cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass

        },
        { name: 'FileDescription', displayName: 'File Description', headerCellFilter: 'translate',cellClass: getCellClass, enableColumnResizing: true, width: "25%", minWidth: 100 },
        {
    ...
    $scope.loadAsset = function (data) {
      //  var _url = "/Equipment/GetEquipmentByStatus?lId=" + $scope.language.LanguageId + "&eId=" + data + "&rId=0&type=Drive&status=All";
