app.requires.push('chart.js', 'ngTouch');
...
app.controller('skfCtrl', function ($scope, $filter, $timeout, $http) {
    ...
    $scope.loadChart1 = function () {
        $scope.chartData1.labels = ["Download Sales", "In-Store Sales", "Mail-Order Sales"];
        $scope.chartData1.data = [300, 500, 100];
        $scope.chartData1.type = "pie";
        $scope.chartData1.type1 = "doughnut";
    }
    ...
    $scope.loadChart2 = function () {
        $scope.chartData2.labels = ["Download Sales", "In-Store Sales", "Mail-Order Sales"];
        $scope.chartData2.data = [300, 500, 100];
        $scope.chartData2.type = "bar";
        $scope.chartData2.series = ['Series A'];
    }

    $scope.loadChart2();

    $scope.loadChart3 = function () {
        $scope.chartData3.labels = ["January", "February", "March", "April", "May", "June", "July"];
        $scope.chartData3.data = [
            [65, 59, 80, 81, 56, 55, 40],
            [28, 48, 40, 19, 86, 27, 90]
        ];
        $scope.chartData3.type = "line";
        $scope.chartData3.series = ['Series A', 'Series B'];
    }
 ...
 */
    ...
    $scope.chartWithTimeLine();

    $scope.loadDonutChart = function () {
        ...
        Highcharts.chart('container3', {
            ...
            series: [{
                name: 'Consequence',
                data: [
                    ['Additive Breakdown', 8],
                    ['Bearing Fault', 3],
                    ['Bearing Fault, Inner Race Defect', 1],
                    ['Bent Shaft', 6],
                    ['Cavitation', 8],
                    ['Dirt Ingress', 4],
                    ['Electrical Fault', 4],
                    ['Electrical Fault, Cable Defect', 1],
                    ['Electrical Fault, Harmonic Distortion', 1]
                ]
            }]
        });
    }
    $scope.loadDonutChart();
