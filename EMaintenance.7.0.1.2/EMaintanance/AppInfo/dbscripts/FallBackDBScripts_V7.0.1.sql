...
--
-- Drop procedure [dbo].[EAppListBearingByDesignation]
--
DROP PROCEDURE IF EXISTS [dbo].[EAppListBearingByDesignation]
GO
...
ALTER TABLE [dbo].[Equipment]
  ALTER
    COLUMN [EquipmentCode] [nvarchar](30)
GO
IF @@ERROR<>0 OR @@TRANCOUNT=0 BEGIN IF @@TRANCOUNT>0 ROLLBACK SET NOEXEC ON END
GO
...
CREATE OR ALTER PROCEDURE [dbo].[EAppListEquipmentDriveUnit]
	@EquipmentId int,
	@DriveUnitId int,
	@LanguageId int, 
	@Action varchar(75), -- Attachment | Services
