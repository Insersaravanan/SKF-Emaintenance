...
namespace EMaintanance.ViewModels
{
    public class JobUnitAnalysisViewModel
    {
        ...
        [JsonIgnore]
        [JsonProperty(PropertyName = "JobPrevUnitSymptomsListJson")]
        public string JobPrevUnitSymptomsListJson { get; set; }
        [JsonIgnore]
        [JsonProperty(PropertyName = "JobPrevUnitAmplitudeListJson")]
        public string JobPrevUnitAmplitudeListJson { get; set; }
        [JsonIgnore]
        [JsonProperty(PropertyName = "JobPrevConditionJson")]
        public string JobPrevConditionJson { get; set; }
        [JsonProperty(PropertyName = "JobPrevUnitSymptomsList")]
        public List<JobUnitSymptomsViewModel> JobPrevUnitSymptomsList { get; set; }
        [JsonProperty(PropertyName = "JobPrevUnitAmplitudeList")]
        public List<JobUnitAmplitudeViewModel> JobPrevUnitAmplitudeList { get; set; }
        [JsonProperty(PropertyName = "JobPrevCondition")]
        public List<JobConditionViewModel> JobPrevCondition { get; set; }
    }
    ...
    public class JobConditionViewModel
    {
        [JsonProperty(PropertyName = "UnitAnalysisId")]
        public int UnitAnalysisId { get; set; }
        [JsonProperty(PropertyName = "JobEquipmentId")]
