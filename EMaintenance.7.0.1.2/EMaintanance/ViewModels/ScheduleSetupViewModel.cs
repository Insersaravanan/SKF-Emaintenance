...
namespace EMaintanance.ViewModels
{
    public class ScheduleSetupViewModel
    {
        ...
        public List<ScheduleServicesViewModel> ScheduleServices { get; set; }
        [JsonProperty(PropertyName = "ScheduleEquipments")]
        public List<ScheduleEquipmentsViewModel> ScheduleEquipments { get; set; }

    }

    public class ScheduleEquipmentsViewModel
    {
