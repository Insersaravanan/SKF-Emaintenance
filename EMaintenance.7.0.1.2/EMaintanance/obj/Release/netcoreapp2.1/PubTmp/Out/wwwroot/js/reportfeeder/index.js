...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $translate, $rootScope,$uibModal, languageFactory, alertFactory, clientFactory, $timeout) {
    $scope.startIndex = 1;
    $scope.isEdit = false;
    ...
    var _columns = [
        ...
        {
            name: 'JobNumber', displayName: 'Job Number', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "10%", minWidth: 100, cellClass: getCellClass, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'JobName', displayName: 'Job Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "20%", minWidth: 200, cellClass: getCellClass },
        { name: 'DataCollectionDate', displayName: 'Data Collection Date', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 100, width: "11%", cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        { name: 'ReportDate', displayName: 'ReportDate', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 80, width: "10%", cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass },
        {
            name: 'VACount', displayName: 'VA', headerCellFilter: 'translate',enableColumnResizing: false, enableCellEdit: false, minWidth: 40, width: '6%', enableFiltering: false, enablePinning: false, cellClass: getCellClass,
        ...
        {
            name: 'OACount', displayName: 'OA', headerCellFilter: 'translate',enableColumnResizing: false, enableCellEdit: false, minWidth: 40, width: '6%', enableFiltering: false, enablePinning: false, cellClass: getCellClass,
        ...
        {
            name: 'StatusName', displayName: 'Job Status', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "8%", minWidth: 120, cellClass: getCellClass,
        ...
        {
            name: 'StatusPercent', displayName: 'Job Progress', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "8%", minWidth: 120, cellClass: getCellClass,
        ...
        {
            name: 'Action', headerCellFilter: 'translate',enableFiltering: false, enableSorting: false, enableCellEdit: false, cellClass: getCellClass,
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                ...
                '<a ng-click="grid.appScope.Report(row)" ng-class="{disable:row.entity.StatusCode == \'NS\' || row.entity.StatusName == \'In Progress\'}"><i class="fa fa-align-left icon-space-before" tooltip-append-to-body="true" uib-tooltip="Summary Report" tooltip-class="customClass import-tooltip"></i></a>' +
    ...
    $scope.columns1 = [
        ...
        {
            name: 'PlantAreaName', displayName: 'Plant', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "15%", minWidth: 100, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'EquipmentName', displayName: 'Equipment Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "13%", minWidth: 100
        },
        {
            name: 'ServiceName', displayName: 'Service Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 100
        },
        {
            name: 'DataCollectionDate', displayName: 'DC Date', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "3%", minWidth: 100, cellFilter: 'date:\'dd/MM/yyyy\''
        },
        {
            name: 'ReportDate', displayName: 'Report Date', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "3%", minWidth: 100, cellFilter: 'date:\'dd/MM/yyyy\''
        },
        {
            name: 'IsWorkNotification', displayName: 'Work Notification', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "9%", minWidth: 100
        },
        {
            name: 'OpenWorkNotifications', displayName: 'Open WN', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "2%", minWidth: 100,
        ...
        {
            name: 'StatusName', displayName: 'Report Status', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "9%", minWidth: 100, cellClass: getCellClass,
            cellTemplate: '<div class="job-status"><span class="grid-status" ng-attr-style="border: 1px solid {{row.entity.StatusColour}};color: {{row.entity.StatusColour}}">{{row.entity.StatusName}}</span></span>'
        },
        {
            name: 'Action', headerCellFilter: 'translate', enableFiltering: false, enableSorting: false, cellClass: getCellClass,
            cellTemplate: '<div class="ui-grid-cell-contents">' +
    ...
    $scope.EquipStatus = function (row) {
        var modalInstance = $uibModal.open({
            ...
            resolve: {
                params: function () {
                    return { 'row': row, "languageId": $scope.language.LanguageId, 'DataColDate': $scope.SelectedJob.DataCollectionDate, 'ClientSiteId': $scope.ClientSiteId, 'reviewerId': $scope.ReviewerId, 'jId': $scope.SelectedJob.JobId };
                }
            }
        });
    ...
    $scope.columns2 = [
        ...
        {
            name: 'EquipmentName', displayName: 'Equipment Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "15%", minWidth: 100, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'UnitType', displayName: 'Unit Type', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 100,
        },
        {
            name: 'AssetName', displayName: 'Asset Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "18%", minWidth: 100,
        ...
        {
            name: 'ServiceName', displayName: 'Reporting Services', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 100,

        },
        {
            name: 'IsWorkNotification', displayName: 'Work Notification', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 100
        },
        {
            name: 'OpenWorkNotifications', displayName: 'Open WN', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "4%", minWidth: 100,
        ...
        {
            name: 'DataValidationStatus', displayName: 'Data Status', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, width: "13%", minWidth: 100, cellClass: getCellClass,
            ...
            if (row.UnitAnalysisId != 0) {
                $http.get("/ReportFeeder/GetAnalysisByUnit?type=DR&sType=OA&uaId=" + row.UnitAnalysisId + "&lId=" + $scope.language.LanguageId)
                    .then(function (response) {
                        ...
                        if ($scope.o_Drive.JobPrevCondition === null) {
                            $scope.isClone = false;
                        }
                    });
            }
            ...
            if (row.UnitAnalysisId != 0) {
                ...
                $http.get("/ReportFeeder/GetAnalysisByUnit?type=DR&sType=VA&uaId=" + row.UnitAnalysisId + "&lId=" + $scope.language.LanguageId)
                    .then(function (response) {
                        ...
                        if ($scope.v_Drive.JobPrevCondition === null) {
                            $scope.isClone = false;
                        }
                        ...
                        $scope.AmplitudeDrive = $scope.v_Drive.JobUnitAmplitudeList !== null ? $scope.v_Drive.JobUnitAmplitudeList : [];
                        if ($scope.AmplitudeDrive.length <= 0) {
                            var a = 0;
                        } else {
                            a = $scope.AmplitudeDrive.length;
                        }
    ...
    $scope.viewDriveRow = function (row) {
        ...
        $scope.clearModal();
        $scope.DrUnitAnalysisId = row.UnitAnalysisId;
        $scope.UnitId = row.UnitId;
        $scope.JobEquipmentId = row.JobEquipmentId;
        $scope.ServiceId = row.ServiceId;
        $scope.EquipmentId = row.EquipmentId;
    ...
    $scope.FeedData1 = function (row) {
        ...
        $scope.InUnitAnalysisId = row.UnitAnalysisId;
            ...
            if (row.UnitAnalysisId != 0) {
                $http.get("/ReportFeeder/GetAnalysisByUnit?type=IN&sType=OA&uaId=" + row.UnitAnalysisId + "&lId=" + $scope.language.LanguageId)
                    .then(function (response) {
                        ...
                        if ($scope.o_Inter.JobPrevCondition === null) {
                            $scope.isClone = false;
                        }
                    });
            }
            ...
            if (row.UnitAnalysisId != 0) {
                ...
                $http.get("/ReportFeeder/GetAnalysisByUnit?type=IN&sType=VA&uaId=" + row.UnitAnalysisId + "&lId=" + $scope.language.LanguageId)
                    .then(function (response) {
                        ...
                        $scope.isEditInter = true;
                        $scope.isCreateInter = false;
                        if ($scope.v_Intermediate.JobPrevCondition === null) {
                            $scope.isClone = false;
                        }
                        $scope.VAInterData = $scope.v_Intermediate.JobUnitSymptomsList;
                        ...
                        $scope.AmplitudeInter = $scope.v_Intermediate.JobUnitAmplitudeList !== null ? $scope.v_Intermediate.JobUnitAmplitudeList : [];

                        if ($scope.AmplitudeInter.length <= 0) {
                            var a = 0;
                        } else {
            ...
            if (row.UnitAnalysisId !== 0) {
                $http.get("/ReportFeeder/GetAnalysisByUnit?type=DN&sType=OA&uaId=" + row.UnitAnalysisId + "&lId=" + $scope.language.LanguageId)
                    .then(function (response) {
                        ...
                        if ($scope.o_Driven.JobPrevCondition === null) {
                            $scope.isClone = false;
                        }
                    });
            }
            ...
            if (row.UnitAnalysisId != 0) {
                $http.get("/ReportFeeder/GetAnalysisByUnit?type=DN&sType=VA&uaId=" + row.UnitAnalysisId + "&lId=" + $scope.language.LanguageId)
                    .then(function (response) {
                        ...
                        $scope.isCreateDriven = false;
                        $scope.VADrivenData = $scope.v_Driven.JobUnitSymptomsList;
                        if ($scope.v_Driven.JobPrevCondition === null) {
                            $scope.isClone = false;
                        }
                        ...
                        $scope.AmplitudeDriven = $scope.v_Driven.JobUnitAmplitudeList !== null ? $scope.v_Driven.JobUnitAmplitudeList : [];

                        if ($scope.AmplitudeDriven.length <= 0) {
                            var a = 0;
                        } else {
    ...
    $scope.viewDrivenRow = function (row) {
        ...
        $scope.OpenWorkNotification = row.OpenWorkNotifications;
        $scope.ServiceName = row.ServiceName;
        $scope.DnUnitAnalysisId = row.UnitAnalysisId;
        $scope.isDriven1 = false;
        $scope.isDriven2 = false;
        $scope.isCreateDriven = false;
        $scope.isEditDriven = false;
    ...
    $scope.Clone = function (row, type) {
        var modalInstance = $uibModal.open({
            templateUrl: 'skfCloneConfirmModal.html',
            controller: 'skfCloneConfirmModalCtrl',
            size: 'md',
            backdrop: 'static',
            keyboard: false,
            resolve: {
        ...
        modalInstance.result.then(function (data) {
            ...
            $scope.FaultsDDL9 = $scope.FaultsDDL10 = $scope.FaultsDDL11 = $scope.FaultsDDL12 = $scope.FaultsDDL13 = $scope.FaultsDDL14 = $scope.FaultsDDL15 = $scope.FaultsDDL16 = [];
            $scope.FaultsDDL0 = $scope.FaultsDDL1 = $scope.FaultsDDL2 = $scope.FaultsDDL3 = $scope.FaultsDDL4 = $scope.FaultsDDL5 = $scope.FaultsDDL6 = $scope.FaultsDDL7 = $scope.FaultsDDL8 = [];
            $scope.AmplitudeDrive = $scope.AmplitudeDriven = AmplitudeInter = [];
            if (data.length > 0) {
                $scope.isClone = false;
                switch (type) {
                    case 'DR':
                        if (row.ServiceName === "Oil Analysis") {
                            $scope.loadFailureMode(row.AssetId);
                            $scope.D_Data = "OA";
                            angular.forEach($scope.o_Drive.JobPrevCondition, function (val, i) {
                                $scope.o_Drive.ConditionId = val.ConditionId;
                                // $scope.o_Drive.ConfidentFactorId = val.ConfidentFactorId;
                                // $scope.o_Drive.FailureProbFactorId = val.FailureProbFactorId;
                                $scope.o_Drive.PriorityId = val.PriorityId;
                                $scope.o_Drive.Comment = val.Comment;
                                $scope.o_Drive.Recommendation = val.Recommendation;
                            });

                            // $scope.OADriveData = [];
                            if ($scope.o_Drive.JobPrevUnitSymptomsList !== null) {
                                $scope.OADriveData = $scope.o_Drive.JobPrevUnitSymptomsList;
                                angular.forEach($scope.OADriveData, function (val, i) {
                                    $scope.OADriveData.push(val);
                                    $scope.loadOAInFault(val.FailureModeId);
                                    $scope.o_Drive.Symptoms = val.Symptoms;
                            ...
                            $scope.D_Data = "VA";
                            $scope.loadFailureMode(row.AssetId);
                            angular.forEach($scope.v_Drive.JobPrevCondition, function (val, i) {
                                $scope.v_Drive.ConditionId = val.ConditionId;
                                //$scope.v_Drive.ConfidentFactorId = val.ConfidentFactorId;
                                //$scope.v_Drive.FailureProbFactorId = val.FailureProbFactorId;
                                $scope.v_Drive.PriorityId = val.PriorityId;
                                $scope.v_Drive.Comment = val.Comment;
                                $scope.v_Drive.Recommendation = val.Recommendation;
                            });

                            if ($scope.v_Drive.JobPrevUnitAmplitudeList !== null) {
                                $scope.AmplitudeDrive = $scope.v_Drive.JobPrevUnitAmplitudeList;
                                for (i = 0; i < $scope.AmplitudeDrive.length; i++) {
                                    for (j = 0; j < $scope.v_Drive.JobUnitAmplitudeList.length; j++) {
                                        if (i === j) {
                                            $scope.AmplitudeDrive[i].UnitAmplitudeId = $scope.v_Drive.JobUnitAmplitudeList[j].UnitAmplitudeId;
                                            $scope.AmplitudeDrive[i].UnitAnalysisId = $scope.v_Drive.JobUnitAmplitudeList[j].UnitAnalysisId;
                                        }
                                    }
                                }
                            } else {
                            ...
                            if ($scope.v_Drive.JobPrevUnitSymptomsList !== null) {
                                //for (i = 0; i < $scope.v_Drive.JobUnitSymptomsList.length; i++) {
                                //    for (j = 0; j < $scope.v_Drive.JobPrevUnitSymptomsList.length; j++) {
                                //        if (i === j) {
                                //            $scope.v_Drive.JobPrevUnitSymptomsList[j].UnitSymptomsId = $scope.v_Drive.JobUnitSymptomsList[i].UnitSymptomsId;

                                //        }
                                //    }
                                //}

                                $scope.VADriveData = $scope.v_Drive.JobPrevUnitSymptomsList;
                                angular.forEach($scope.VADriveData, function (val, i) {
                                    // if (val.FailureModeId) {
                                    $scope.loadFrequency(val.FailureModeId, i);
                                    // }
                    ...
                    case 'IN':
                        if (row.ServiceName === "Oil Analysis") {
                            $scope.I_Data = "OA";
                            $scope.loadFailureMode(row.AssetId);
                            angular.forEach($scope.o_Inter.JobPrevCondition, function (val, i) {
                                $scope.o_Inter.ConditionId = val.ConditionId;
                                //$scope.o_Inter.ConfidentFactorId = val.ConfidentFactorId;
                                //$scope.o_Inter.FailureProbFactorId = val.FailureProbFactorId;
                                $scope.o_Inter.PriorityId = val.PriorityId;
                                $scope.o_Inter.Comment = val.Comment;
                                $scope.o_Inter.Recommendation = val.Recommendation;
                            });


                            if ($scope.o_Inter.JobPrevUnitSymptomsList !== null) {
                                $scope.OAInterData = $scope.o_Inter.JobPrevUnitSymptomsList;
                                angular.forEach($scope.OAInterData, function (val, i) {
                                    $scope.OAInterData.push(val);
                                    $scope.loadOAInFault(val.FailureModeId);
                                    $scope.o_Inter.IndicatedFaultId = val.IndicatedFaultId;
                            ...
                            $scope.I_Data = "VA";
                            $scope.loadFailureMode(row.AssetId);
                            angular.forEach($scope.v_Intermediate.JobPrevCondition, function (val, i) {
                                $scope.v_Intermediate.ConditionId = val.ConditionId;
                                //$scope.v_Intermediate.ConfidentFactorId = val.ConfidentFactorId;
                                //$scope.v_Intermediate.FailureProbFactorId = val.FailureProbFactorId;
                                $scope.v_Intermediate.PriorityId = val.PriorityId;
                                $scope.v_Intermediate.Comment = val.Comment;
                                $scope.v_Intermediate.Recommendation = val.Recommendation;
                            });

                            if ($scope.v_Intermediate.JobPrevUnitAmplitudeList !== null) {
                                $scope.AmplitudeInter = $scope.v_Intermediate.JobPrevUnitAmplitudeList;
                                for (i = 0; i < $scope.AmplitudeInter.length; i++) {
                                    for (j = 0; j < $scope.v_Intermediate.JobUnitAmplitudeList.length; j++) {
                                        if (i === j) {
                                            $scope.AmplitudeInter[i].UnitAmplitudeId = $scope.v_Intermediate.JobUnitAmplitudeList[j].UnitAmplitudeId;
                                            $scope.AmplitudeInter[i].UnitAnalysisId = $scope.v_Intermediate.JobUnitAmplitudeList[j].UnitAnalysisId;
                                        }
                                    }
                                }
                            } else {
                            ...
                            if ($scope.v_Intermediate.JobPrevUnitSymptomsList !== null) {
                                //for (i = 0; i < $scope.v_Intermediate.JobUnitSymptomsList; i++) {
                                //    for (j = 0; j < $scope.v_Intermediate.JobPrevUnitSymptomsList.length; j++) {
                                //        if (i === j) {
                                //            $scope.v_Intermediate.JobPrevUnitSymptomsList[j].UnitSymptomsId = $scope.v_Intermediate.JobUnitSymptomsList[i].UnitSymptomsId;
                                //        }
                                //    }
                                //}

                                $scope.VAInterData = $scope.v_Intermediate.JobPrevUnitSymptomsList;
                                angular.forEach($scope.VAInterData, function (val, i) {
                                    // if (val.FailureModeId) {
                                    $scope.loadFrequency(val.FailureModeId, i);
                                    // }
                    ...
                    case 'DN':
                        if (row.ServiceName === "Oil Analysis") {
                            $scope.Dn_Data = "OA";
                            $scope.loadFailureMode(row.AssetId);
                            angular.forEach($scope.o_Driven.JobPrevCondition, function (val, i) {
                                $scope.o_Driven.ConditionId = val.ConditionId;
                                //$scope.o_Driven.ConfidentFactorId = val.ConfidentFactorId;
                                //$scope.o_Driven.FailureProbFactorId = val.FailureProbFactorId;
                                $scope.o_Driven.PriorityId = val.PriorityId;
                                $scope.o_Driven.Comment = val.Comment;
                                $scope.o_Driven.Recommendation = val.Recommendation;
                            });
                            if ($scope.o_Driven.JobPrevUnitSymptomsList !== null) {
                                $scope.OADrivenData = $scope.o_Driven.JobPrevUnitSymptomsList;
                            ...
                            $scope.loadFailureMode(row.AssetId);
                            $scope.Dn_Data = "VA";
                            angular.forEach($scope.v_Driven.JobPrevCondition, function (val, i) {
                                $scope.v_Driven.ConditionId = val.ConditionId;
                                //$scope.v_Driven.ConfidentFactorId = val.ConfidentFactorId;
                                //$scope.v_Driven.FailureProbFactorId = val.FailureProbFactorId;
                                $scope.v_Driven.PriorityId = val.PriorityId;
                                $scope.v_Driven.Comment = val.Comment;
                                $scope.v_Driven.Recommendation = val.Recommendation;
                            });


                            if ($scope.v_Driven.JobPrevUnitAmplitudeList !== null) {
                                $scope.AmplitudeDriven = $scope.v_Driven.JobPrevUnitAmplitudeList;
                                for (i = 0; i < $scope.AmplitudeDriven.length; i++) {
                                    for (j = 0; j < $scope.v_Driven.JobUnitAmplitudeList.length; j++) {
                                        if (i === j) {
                                            $scope.AmplitudeDriven[i].UnitAmplitudeId = $scope.v_Driven.JobUnitAmplitudeList[j].UnitAmplitudeId;
                                            $scope.AmplitudeDriven[i].UnitAnalysisId = $scope.v_Driven.JobUnitAmplitudeList[j].UnitAnalysisId;
                                        }
                                    }
                                }
                            } else {
                            ...
                            if ($scope.v_Driven.JobPrevUnitSymptomsList !== null) {
                                //for (i = 0; i < $scope.v_Driven.JobUnitSymptomsList; i++) {
                                //    for (j = 0; j < $scope.v_Driven.JobPrevUnitSymptomsList.length; j++) {
                                //        if (i === j) {
                                //            $scope.v_Driven.JobPrevUnitSymptomsList[j].UnitSymptomsId = $scope.v_Driven.JobUnitSymptomsList[i].UnitSymptomsId;
                                //        }
                                //    }
                                //}

                                $scope.VADrivenData = $scope.v_Driven.JobPrevUnitSymptomsList;
                                angular.forEach($scope.VADrivenData, function (val, i) {
                                    // if (val.FailureModeId) {
                                    $scope.loadFrequency(val.FailureModeId, i);
                                    // }
...
app.controller('skfEquipStatusCtrl', function ($scope, $http, $filter, $uibModal, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    $scope.IsEditable = params.row.IsEditable;
    $scope.ReviewerId = params.reviewerId;
...
app.controller('skfLeverageServiceCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columnsla = [
        ...
        {
            name: 'OpportunityType', displayName: 'Opportunities', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true, width: "35%",
            minWidth: 50
        },
        {
            name: 'Descriptions', displayName: 'Description', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: true, width: "40%", minWidth: 50
        },
        {
            name: 'Active', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false, enableCellEdit: false,
            //filter: {
...
app.controller('SelectAssetModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'PlantName', displayName: 'Plant Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'AreaName', displayName: 'Area Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'System', displayName: 'System Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'EquipmentName', displayName: 'Equipment Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'AssetName', displayName: 'Asset Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 100
        },
        {
            name: 'Active', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false, enableCellEdit: false,
...
app.controller('skfCloneConfirmModalCtrl', function ($scope, $http, $uibModalInstance, params, $window, uiGridConstants, alertFactory, $timeout) {
    $scope.formatters = {};
