...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $rootScope, $translate,  $uibModal, languageFactory, alertFactory, clientFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'FileName', displayName: 'File Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "32%", minWidth: 100, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'FileDescription', displayName: 'File Description', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "35%", minWidth: 100 },
        {
