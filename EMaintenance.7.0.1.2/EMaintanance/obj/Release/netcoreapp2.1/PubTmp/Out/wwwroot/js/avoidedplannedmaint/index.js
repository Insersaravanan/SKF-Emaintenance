...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, $rootScope, $translate, languageFactory, alertFactory, clientFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'ActualRepairCost', displayName: 'Avoided PM Cost ($)', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "16%", minWidth: 100 },
        { name: 'DownTimeCost', displayName: 'Down Time Cost ($)', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 100 },
        { name: 'TrueSavingsCost', displayName: 'True Savings', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 100 },
        { name: 'TrueSavingsHrs', displayName: 'True Savings Hrs', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 100 },
        { name: 'CreatedBy', displayName: 'Action Taken', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "16%", minWidth: 100 },
        {
            name: 'ReportDate', displayName: 'Date of Report', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 80, width: "18%", cellFilter: 'date:\'dd/MM/yyyy\'', cellClass: getCellClass, aggregationType: uiGridConstants.aggregationTypes.count,
