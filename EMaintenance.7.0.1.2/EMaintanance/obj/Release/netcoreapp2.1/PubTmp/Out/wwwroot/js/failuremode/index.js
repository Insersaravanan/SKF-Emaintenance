...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, languageFactory,$rootScope,$translate, alertFactory,$timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'FailureModeCode', displayName: 'Failure Mode Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "15%", minWidth: 150, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'FailureModeName', displayName: 'Failure Mode Name', headerCellFilter: 'translate',cellClass: getCellClass, enableColumnResizing: true, width: "25%", minWidth: 150 },
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditFailureMode"|translate}} tooltip-class="customClass"></i></a>' +
                ...
                '<a ng-click="grid.appScope.FmodeType(row.entity)" <i class="fa fa-link icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"FailureMode-AssetClassRelation"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "9%",
            minWidth: 100
        }
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory,$timeout) {
    ...
    var _columns  = [
        ...
        { name: 'FailureModeName', displayName: 'Failure Mode Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
...
app.controller('skfFailureModeTypeModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory,$timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'AssetClassName', displayName: 'Asset Class Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true, minWidth: 150
        },
        {
            name: 'Active', displayName: 'Linked', headerCellFilter: 'translate', enableFiltering: false,
            headerCellTemplate: '<label class="ui-grid-cell-contents"><span>{{"SelectAll"|translate}} &nbsp;&nbsp</span><input type="checkbox" class="header-checkbox" ng-disabled="row.entity.isView == \'T\'" ng-click="grid.appScope.SelectAll()" ng-true-value="\'Y\'" ng-false-value="\'N\'"></label>',
