...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, $rootScope, $translate, languageFactory, alertFactory, clientFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'ClientName', displayName: 'Client Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "10%", minWidth: 100 },
        { name: 'PlantArea', displayName: 'Plant', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "12%", minWidth: 100 },
        { name: 'EquipmentName', displayName: 'Equipment Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "12%", minWidth: 100 },
        { name: 'JobNumber', displayName: 'Job Number', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "5%", minWidth: 100 },
        {
            name: 'OpportunityType', displayName: 'Opportunities', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "20%",
            minWidth: 100,aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },  
        { name: 'Descriptions', displayName: 'Descriptions', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "24%", minWidth: 100 },
        {
            name: 'Status', displayName: 'Action',headerCellFilter: 'translate', enableFiltering: false, enableCellEdit: false,
    ...
    $scope.save = function () {
        ...
        if (!$scope.isProcess && LeverageServices.length > 0) {
            ...
            var postUrl = "/LeverageExport/ExportLeverage?csId=" + $scope.ClientSiteId;
    ...
    var _columns1 = [
        ...
        { name: 'FileDate', displayName: 'File Date', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "20%", minWidth: 50, cellFilter: 'date:\'dd/MM/yyyy\'' },
        { name: 'FileName', displayName: 'File Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "30%", minWidth: 50 },
        { name: 'FilePath', displayName: 'File Path', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, width: "28%", minWidth: 50 },
        {
