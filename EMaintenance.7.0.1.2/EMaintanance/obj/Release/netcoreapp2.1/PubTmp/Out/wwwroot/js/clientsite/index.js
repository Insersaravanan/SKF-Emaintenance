...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $rootScope, $translate, $uibModal, $window, languageFactory, alertFactory, $timeout, clientFactory) {
    $scope.startIndex = 1;
    ...
    var _columns = [
        ...
        { name: 'ClientName', displayName: 'Client Group', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "18%", minWidth: 100 },
        {
            name: 'SiteName', displayName: 'Client Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "20%", minWidth: 100, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'CountryName', displayName: 'Country', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "8%", minWidth: 100 },
        { name: 'CostCentreName', displayName: 'Branch', headerCellFilter: 'translate',cellClass: getCellClass, enableColumnResizing: true, width: "9%", minWidth: 100 },
        { name: 'City', displayName: 'City', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "9%", minWidth: 100 },
        { name: 'StateName', displayName: 'State', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "7%", minWidth: 100 },
        {
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditClient"|translate}} tooltip-class="customClass"></i></a>' +
                ...
                '<a ng-click="grid.appScope.conditioncodemapping(row.entity)" <i class="fa fa-arrows  icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"ConditionCodeMapping"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.programtypemapping(row.entity)" <i class="fa fa-product-hunt  icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"ProgramTypeMapping"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.configuration(row.entity)" <i class="fa fa-th-large  icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"ClientSiteConfiguration"|translate}} tooltip-class="customClass"></i></a>' +
    ...
    $scope.searchToggle = function () {
        ...
        $scope.isEdit = false;
        $scope.isSearch = true;
      //  isSearch.isFirstDisabled = true;
        $scope.Logo = "";
        $scope.S_ClientSite.LookupId = null;
    ...
    $scope.loadProgramType = function (_data) {
        $scope.ProgramTypeDDL = [];
        $scope.defaultProgramType = {
            LookupId: null,
            LValue: "--Select--"
        }
        ...
        $http.get(_url)
            .then(function (response) {
                ...
                $scope.ProgramTypeDDL.splice(0, 0, $scope.defaultProgramType);
            });
    //    $scope.ProgramTypeDDL = response.data[0];

    };


    //$scope.loadClientListByProgramType = function (_data) {
    //    var _url = "/Client/GetClientListByProgramType?lId=" + $scope.language.LanguageId + "&ProgramTypeId=" + $scope.LookupId;
    // //   var _url = "/Client/GetClientListByProgramType?lId=" + $scope.language.LanguageId + "&ProgramTypeId=CostCentre&cId=" + _data + "&ccId=";
    //  //  var _url = "/OtherReports/GetEquipmentByPlant?lId=" + $scope.language.LanguageId + "&ProgramTypeId=" + $scope.PlantAreaId;
    ...
    //        });
    //};
    $scope.loadClientListByProgramType = function (data) {
        $scope.gridOpts.data = [];
        $scope.isPageLoad = true;
        console.log(data);
        if (data != 0)
        {
            var _url = "/ClientSite/GetClientSiteByProgramType?lId=" + $scope.language.LanguageId + "&ProgramTypeId=" + data;
            $http.get(_url)
                .then(function (response) {
                    $scope.gridOpts.data = response.data;
                    angular.forEach($scope.gridOpts.data, function (val, i) {
                ...
                if (response.data) {
                    if (response.data.toString().indexOf("<!DOCTYPE html>") >= 0) {
                        ...
                        if (data == "goto") {
                            ...
                            //            if (val.ClientSiteId == $scope.Id) {Update Info
    ...
    $scope.programtypemapping = function (row) {
        var modalInstance = $uibModal.open({
            templateUrl: 'skfProgramTypeModal.html',
            controller: 'skfProgramTypeModalCtrl',
            size: 'lg',
            backdrop: 'static',
            keyboard: false,
            resolve: {
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'LanguageName', displayName: 'Language ', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
        ...
        { name: 'SiteName', displayName: 'Site Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 120 },
        { name: 'StateName', displayName: 'State', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 120 },
        { name: 'City', displayName: 'City', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 120 },
        { name: 'Address1', displayName: 'Address 1', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 120 },
...
app.controller('skfConditionCodeMapModalCtrl', function ($scope, $http, $uibModalInstance, params, $uibModal, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'SKFConditionname', displayName: 'SKF Condition Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, minWidth: 120 },
        { name: 'SKFConditionCode', displayName: 'SKF Condition Code', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, minWidth: 120 },
        { name: 'ClientsConditionName', displayName: 'Client Condition Name*', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 100 },
        ...
        {
            name: 'Active', displayName: 'Linked', headerCellFilter: 'translate', enableFiltering: false,
            headerCellTemplate: '<label class="ui-grid-cell-contents"><span>{{"Active"|translate}} &nbsp;&nbsp</span><ng-click="grid.appScope.SelectAll()" ng-true-value="\'Y\'" ng-false-value="\'N\'"></label>',
        ...
        {
            name: 'Action', headerCellFilter: 'translate', enableFiltering: false, enableSorting: false, enableCellEdit: false,
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.ConditionCodeLanguage(row.entity)" ng-class="{disable: (row.entity.CMappingId == null)}" <i class="fa fa-language icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"MultiLanguage"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "6%",
            minWidth: 80
        }
...
app.controller('skfConditionCodeLagModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'ClientsConditionName', displayName: 'Condition Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 120 },
        { name: 'Descriptions', displayName: 'Description', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 120 }
    ];
...
//Program Type popup controller
app.controller('skfProgramTypeModalCtrl', function ($scope, $http, $uibModalInstance, params, $uibModal, alertFactory, $timeout) {
    var _param = params;
    $scope.sitename = params.row.SiteName;
    $scope.lanid = params.row.LanguageId;
    $scope.ClientSiteId = params.row.ClientSiteId;
    ...
    $scope.LoadData = function () {
        $http.get("/ProgramTypeMap/GetProgramTypeSetup?lId=" + $scope.lanid + "&csId=" + $scope.ClientSiteId)
            .then(function (response) {
                angular.forEach(response.data, function (val, i) {
                    $scope.gridOpts3.data = response.data;
                    angular.forEach($scope.gridOpts3.data, function (val, i) {
    ...
    var _columns = [
        ...
        { name: 'SKFProgramTypename', displayName: 'SKF ProgramType Name', enableColumnResizing: true, enableCellEdit: false, enableFiltering: true, minWidth: 250 },
        {
         ...
         //   type: 'boolean', cellTemplate: '<label class="ui-grid-cell-contents"><input type="checkbox" ng-model="row.entity.Active" ng-click="grid.appScope.DirtyValues(row.entity)" ></label>',
            headerCellTemplate: '<label class="ui-grid-cell-contents"><span>Active &nbsp;&nbsp</span><input type="checkbox" class="header-checkbox" ng-disabled="grid.appScope.isView" ng-click="grid.appScope.SelectAll()" ng-true-value="\'Y\'" ng-false-value="\'N\'"></label>',
    ...
    $scope.gridOpts3 = {
        ...
        exporterMenuPdf: false,
        exporterMenuCsv: false,
        exporterExcelFilename: 'EMaintenance_ProgramTypeCodeClientMapping.xlsx',
        exporterExcelSheetName: 'EMaintenance_ProgramTypeCodeClientMapping',
        onRegisterApi: function (gridApi) {
            $scope.gridApi = gridApi;
    ...
    $scope.save = function (data) {
        //$scope.isClientProgramTypeName = true;
        var postData = [];
        angular.forEach($scope.gridOpts3.data, function (val, i) {
            //if (val.ClientsProgramTypeName == null || val.ClientsProgramTypeName == "") {
            //    $scope.isClientProgramTypeName = false;
            //}
            val.LanguageId = $scope.lanid;
            if (val.PTMappingId === null) {
                val.PTMappingId = 0;
                val.PTMappingTId = 0;
                val.UserId = 0;
            }
        ...
        if (!$scope.isProcess) {
            $scope.isProcess = true;
            var postUrl = "/ProgramTypeMap/Create";
            $http.post(postUrl, JSON.stringify(postData)).then(function (response) {
                if (response.status) {
                    if (response.data.toString().indexOf("<!DOCTYPE html>") >= 0) {
                        alertFactory.setMessage({
            ...
            alertFactory.setMessage({
                type: "warning",
                msg: "Client ProgramType name should not be empty",
            });
        }
    ...
    $scope.ProgramTypeLanguage = function (row) {
        $http.get("/ProgramTypeMap/GetTransProgramTypeMapping?CMappingId=" + row.CMappingId)
            .then(function (response) {
                angular.forEach(response.data, function (val, i) {
                    val.sno = i + 1;
                });
                ...
                var modalInstance = $uibModal.open({
                    templateUrl: 'skfProgramTypeLagModal.html',
                    controller: 'skfProgramTypeLagModalCtrl',
                    size: 'lg',
                    backdrop: 'static',
                    keyboard: false,
                    resolve: {
...
app.controller('skfConfigurationModalCtrl', function ($scope, $http, $uibModalInstance, params, $uibModal, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'ConfigName', displayName: 'Config Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 120 },
        { name: 'ConfigCode', displayName: 'Config Code', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: false, minWidth: 80 },
        { name: 'ClientSiteConfigValue', displayName: 'Config Value', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, minWidth: 80 }
...
app.controller('skfUsersiteAccessCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $uibModal) {
    ...
    var _columns = [
        ...
        {
            name: 'UserName', displayName: 'User Name', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true, cellClass: getCellClass, minWidth: 150
        },
        { name: 'FirstName', displayName: 'First Name', headerCellFilter: 'translate', enableCellEdit: false, enableColumnResizing: true, enableFiltering: true, cellClass: getCellClass, minWidth: 120 },
        { name: 'LastName', displayName: 'Last Name', headerCellFilter: 'translate', enableCellEdit: false, enableColumnResizing: true, enableFiltering: true, cellClass: getCellClass, minWidth: 120 },
        { name: 'RoleGroupName', displayName: 'Role Group Name', headerCellFilter: 'translate', enableCellEdit: false, enableColumnResizing: true, enableFiltering: true, cellClass: getCellClass, minWidth: 120 }
