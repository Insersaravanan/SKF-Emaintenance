...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    var _param = params;
    $scope.AreaName = params.row.AreaName;
    $scope.formatters = {};
    ...
    var _columns = [
        ...
        { name: 'AreaName', displayName: 'Area Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
    ...
    $scope.gridOpts2 = {
        ...
        exporterMenuPdf: false,
        exporterMenuCsv: false,
        exporterExcelFilename: 'EMaintenance_Area.xlsx',
        exporterExcelSheetName: 'EMaintenance_Area',
        onRegisterApi: function (gridApi) {
            $scope.gridApi = gridApi;
    ...
    $scope.save = function () {
        ...
        if (!$scope.isProcess) {
            $scope.isProcess = true;
            var postUrl = "/Area/SaveMultilingual";
...
//    $scope.AreaName = params.AreaName;
//    $scope.isClone = true;

//    $scope.clone = function () {
//        $scope.CloneCount;

//        var _url = "/equipment/Clone?type=" + params.Type + "&cc=" + $scope.CloneCount + "&aId=" + params.AreaId + "&lId=" + $scope.languageId;

//        $http.get(_url).then(function (response) {
//            if (response) {
//                $scope.AreaCloneDDL = response.data;
//                $scope.isClone = false;
