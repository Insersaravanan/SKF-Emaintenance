...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, $rootScope, $translate, languageFactory, alertFactory, clientFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'JobNumber', displayName: 'Job Number', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "5%", minWidth: 100 },
        {
            name: 'PlantAreaName', displayName: 'Plant Area Name', headerCellFilter: 'translate', enableColumnResizing: true, width: "16%", minWidth: 100,
        ...
        { name: 'EquipmentName', displayName: 'Equipment', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "16%", minWidth: 100 },
        { name: 'LSQuoteReference', displayName: 'CRM Reference', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "16%", minWidth: 100 },
        { name: 'LSQuoteAmount', displayName: 'Quote Amount',headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, enableCellEdit: false, minWidth: 80, width: "10%" },
        { name: 'LSQuoteComment', displayName: 'Descriptions', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "18%", minWidth: 150 },
        { 
    ...
    $scope.loadData = function () {
        $scope.gridOpts.data = [];
       // COMMENTS BY SSK ON 20-03-2020  var _url = "/Leverage/GetLeverage?fromdate=" + $filter('date')($scope.L_Leverage.FromDate, "yyyy-MM-dd 00:00:00") + "&todate=" + $filter('date')($scope.L_Leverage.ToDate, "yyyy-MM-dd 00:00:00") + "&lId=" + $scope.language.LanguageId + "&csId=" + $scope.ClientSiteId;
        var _url = "/Leverage/GetLeverageByCustomerID?fromdate=" + $filter('date')($scope.L_Leverage.FromDate, "yyyy-MM-dd 00:00:00") + "&todate=" + $filter('date')($scope.L_Leverage.ToDate, "yyyy-MM-dd 00:00:00") + "&lId=" + $scope.language.LanguageId + "&csId=" + $scope.ClientSiteId;
        $http.get(_url)
