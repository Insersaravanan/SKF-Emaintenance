...
app.controller('skfCtrl', function ($scope, $filter, $window, $timeout, $http, $rootScope, $translate, $uibModal, uiGridConstants, utility, clientFactory, languageFactory) {

    $scope.columns = [
        { name: 'sno', displayName: '#', width: "50", enablePinning: false, enableCellEdit: false, enableFiltering: false },
        { name: 'JobNumber', displayName: 'Job No', headerCellFilter: 'translate', enableColumnResizing: true, width: '20%', enableCellEdit: false },
        { name: 'JobName', displayName: 'Job Name', headerCellFilter: 'translate', enableColumnResizing: true, width: '30%', enableCellEdit: false },
        { name: 'EstStartDate', displayName: 'Est. Start Date', headerCellFilter: 'translate', enableColumnResizing: true, width: '30%', enableCellEdit: false },
        {
            name: 'Action', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false, enableSorting: false, cellClass: getCellClass, enableCellEdit: false,
            width: "15%", minWidth: 100,
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.Report(row)" <i class="fa fa-print icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"SummaryReport"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>'
        }
    ];
