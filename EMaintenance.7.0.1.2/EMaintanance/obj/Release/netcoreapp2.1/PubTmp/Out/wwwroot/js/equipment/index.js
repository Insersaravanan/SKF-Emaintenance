...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $translate, $rootScope, $uibModal, languageFactory, alertFactory, $timeout, clientFactory, $window, $sce) {
    $scope.startIndex = 1;
    $scope.isEdit = false;
    ...
    $scope.columns = [
        ...
        {
            name: 'PlantAreaName', displayName: 'Plant', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "14%", minWidth: 100, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >Total Count: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'AreaName', displayName: 'Area', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "13%", minWidth: 100 },
        { name: 'SystemName', displayName: 'System', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "13%", minWidth: 100 },
        { name: 'EquipmentCode', displayName: 'Equipment Number', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "10%", minWidth: 100 },
        {
            name: 'EquipmentName', displayName: 'Equipment Name', headerCellFilter: 'translate',  cellClass: getCellClass, enableColumnResizing: true, width: "14%", minWidth: 100,
        ...
        { name: 'ListOrder', displayName: 'Reporting Order', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "9%", minWidth: 100 },
        {
        ...
        },
        {
            ...
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"EditEquipment"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.newFile(row)"><i class="fa fa-file-picture-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"UploadFile"|translate}}  tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.clone(row)"><i class="fa fa-clone icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"CloneUnit"|translate}}  tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.failureReport(row.entity)"><i class="fa fa-openid icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"FailureReport"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.AvoidedPlMain(row.entity)"><i class="fa fa-gg icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"AvoidedPlannedMaintenance"|translate}}  tooltip-class="customClass"></i></a>' +
                '</div>',
            width: "14%",
            minWidth: 150
        }
    ...
    $scope.import = function () {
        ...
        var modalInstance = $uibModal.open({
            ...
            resolve: {
                params: function () {
                    return { "language": $scope.language, "templateName": $scope.equipment };
                }
            }
        });
    ...
    $scope.columns1 = [
        ...
        {
            name: 'IdentificationName', displayName: 'Asset Name', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "28%", minWidth: 250, aggregationType: uiGridConstants.aggregationTypes.count,
        ...
        {
            name: 'AssetCode', displayName: 'Taxonomy Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "20%", minWidth: 200
        },
        {
            name: 'ListOrder', displayName: 'List Order', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "18%", minWidth: 200
        },
        {
            name: 'Active', displayName: 'Status', headerCellFilter: 'translate', cellClass: getCellClass,
            cellTemplate: '<div class="status"> {{ row.entity.Active == "Y" ? "&nbsp;Active" : "&nbsp;Inactive" }}</div>',
    ...
    $scope.createDriveToggle = function () {
        ...
        $scope.clearOutDrive();
        $scope.clearDriveModal();
        $scope.shaftDriveUnitValid = false;
    ...
    $scope.columns2 = [
        ...
        {
            name: 'ListOrder', displayName: 'Reporting Order', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "18%", minWidth: 150
        },
        {
            name: 'Active', displayName: 'Status', headerCellFilter: 'translate', cellClass: getCellClass,
            cellTemplate: '<div class="status"> {{ row.entity.Active == "Y" ? "&nbsp;Active" : "&nbsp;Inactive" }}</div>',
    ...
    $scope.createInterToggle = function () {
        ...
        $scope.clearOutInter();
        $scope.clearIntermediateModal();
        $scope.shaftIntermediateUnitValid = false;
    ...
    $scope.openInterDrivenShaftModal = function (row, readonly, type) {
        var modalInstance = $uibModal.open({
            ...
            if (data) {
                switch (type) {
                    case 'IN':
                        ...
                        $scope.shaftIntermediateUnitValid = true;
                        break;
                    case 'DN':
                        $scope.DrivenUnit.Shaft = data;
                        $scope.DrivenUnit.isDirty = true;
                        $scope.shaftDrivenUnitValid = true;
                        break;
                }
            }
        }, function () {
    ...
    $scope.openDriveShaftModal = function (row, readonly, type) {
        var modalInstance = $uibModal.open({
            templateUrl: 'skfDriveShaftModal.html',
            controller: 'skfShaftModalCtrl',
            size: 'lg',
            backdrop: 'static',
            keyboard: false,
        ...
        modalInstance.result.then(function (data) {
            if (data) {
                ...
                $scope.shaftDriveUnitValid = true;
                }
    ...
    $scope.SelectShaft = function (type) {
        switch (type) {
            case 'DR':
                $scope.openDriveShaftModal($scope.driveUnit, $scope.readOnlyDrivePage, type);
                break;
            case 'IN':
                $scope.openInterDrivenShaftModal($scope.intermediateUnit, $scope.readOnlyInterPage, type);
                break;
            case 'DN':
                $scope.openInterDrivenShaftModal($scope.DrivenUnit, $scope.readOnlyDrivenPage, type);
                break;
        }
    };
    ...
    $scope.columns3 = [
        ...
        {
            name: 'AssetCode', displayName: 'Taxonomy Code', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "22%", minWidth: 200
        },
        {
            name: 'ListOrder', displayName: 'Reporting Order', headerCellFilter: 'translate', cellClass: getCellClass, enableColumnResizing: true, width: "12%", minWidth: 150
        },
        {
            name: 'Active', displayName: 'Status', headerCellFilter: 'translate', cellClass: getCellClass,
            cellTemplate: '<div class="status"> {{ row.entity.Active == "Y" ? "&nbsp;Active" : "&nbsp;Inactive" }}</div>',
    ...
    $scope.createDrivenToggle = function () {
        ...
        $scope.shaftDrivenUnitValid = false;
    ...
    $scope.OAPopup = function (row) {
        var modalInstance = $uibModal.open({
            ...
            resolve: {
                params: function () {
                    return { 'ClientSiteId': $scope.ClientSiteId };
                }
            }
        });
...
app.controller('skfAssetTypeModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'AssetCategoryName', displayName: 'Asset Category', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 150
        },
        {
            name: 'AssetClassName', displayName: 'Asset Class', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 150
        },
        {
            name: 'AssetTypeName', displayName: 'Asset Type', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 150
        },
        {
            name: 'AssetSequenceName', displayName: 'Asset Sequence', headerCellFilter: 'translate', enableCellEdit: false, enableFiltering: true,
            minWidth: 150
        },
        {
            name: 'Active', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false, cellTemplate: '<button ng-click="grid.appScope.asset(row.entity)" class="btn btn-primary grid-select-btn">Select</button>',
            width: "15%",
            minWidth: 100
        },
    ];
...
//Quick Equipment input import
app.controller('skfOAPopupCtrl', function ($scope, $http, $uibModalInstance, params, $sce) {
    
    //$scope.languageId = params.languageId;
    $scope.cId = "http://localhost:57130/ImportExelDataInGridView.aspx?ClientSiteID=" + params.ClientSiteId;
