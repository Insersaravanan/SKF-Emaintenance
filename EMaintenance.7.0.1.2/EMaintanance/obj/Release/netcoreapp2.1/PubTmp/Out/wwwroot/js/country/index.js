...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $uibModal, $translate, $rootScope, languageFactory, apiFactory, alertFactory,$timeout) {
    $scope.startIndex = 1;
    $scope.isCreate = true;
    $scope.isEdit = false;
    $scope.isclear = true;
    ...
    var _columns = [
        ...
        {
            name: 'CountryCode', displayName: 'Country Code', headerCellFilter: 'translate', width: '25%', minWidth: 200,cellClass: getCellClass,aggregationHideLabel: false, enableColumnResizing: true,
            cellTemplate: '<div> &nbsp;&nbsp;&nbsp;<img class="grid-flag" src="/images/flags/{{row.entity.CountryCode.toLowerCase()}}.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ row.entity.CountryCode }}</div>'
        },
        {
            name: 'CountryName', displayName: 'Country Name', headerCellFilter: 'translate', cellClass: getCellClass,enableColumnResizing: true, width: "25%", minWidth: 200, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        {
            name: 'Active', displayName: 'Status', headerCellFilter: 'translate', width: "25%", minWidth: 200,
        ...
        {
            name: 'Action', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false, enableSorting: false, width: "19%", minWidth: 100,cellClass: getCellClass,
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Edit Country"|translate}} tooltip-class="customClass"></i></a>' +
                '<a ng-click="grid.appScope.multiLanguage(row)" <i class="fa fa-language icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Multi Language"|translate}} tooltip-class="customClass"></i></a>' +
                '</div>'
        }
    ];
...
app.controller('skfModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, languageFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'LanguageName', displayName: 'Language', headerCellFilter: 'translate', enableCellEdit: false, minWidth: 200, enableFiltering: true,
        ...
        { name: 'CountryName', displayName: 'Country Name', headerCellFilter: 'translate', enableColumnResizing: true, enableFiltering: false, enableCellEdit: true, minWidth: 200, }
    ];
