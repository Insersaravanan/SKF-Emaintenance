...
app.controller('skfCtrl', function ($scope, $filter, uiGridConstants, $http, $rootScope, $translate, $uibModal, languageFactory, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        {
            name: 'ManufacturerCode', displayName: 'Manufacturer Code', headerCellFilter: 'translate', enableColumnResizing: true, width: "10%", minWidth: 80, aggregationHideLabel: false, aggregationType: uiGridConstants.aggregationTypes.count,
            footerCellTemplate: '<div class="ui-grid-cell-contents" >{{"Total Count"|translate}}: {{col.getAggregationValue() | number:0 }}</div>'
        },
        { name: 'ManufacturerName', displayName: 'Manufacturer Name', headerCellFilter: 'translate', enableColumnResizing: true, width: "16%", minWidth: 150 },
        { name: 'BearingMFT', displayName: 'BearingMFT', headerCellFilter: 'translate', enableColumnResizing: true, width: "6%", minWidth: 100 },
        { name: 'DriveMFT', displayName: 'DriveMFT', headerCellFilter: 'translate', enableColumnResizing: true, width: "6%", minWidth: 100 },
        { name: 'IntermediateMFT', displayName: 'IntermediateMFT', headerCellFilter: 'translate', enableColumnResizing: true, width: "10%", minWidth: 100 },
        { name: 'DrivenMFT', displayName: 'DrivenMFT', headerCellFilter: 'translate', enableColumnResizing: true, width: "6%", minWidth: 100 },
        { name: 'Descriptions', displayName: 'Descriptions', headerCellFilter: 'translate', enableColumnResizing: true, width: "16%", minWidth: 150 },
        ...
        {
            name: 'Action', displayName: 'Action', headerCellFilter: 'translate', enableFiltering: false, enableSorting: false,
            cellTemplate: '<div class="ui-grid-cell-contents">' +
                '<a ng-click="grid.appScope.editRow(row.entity)" <i class="fa fa-pencil-square-o icon-space-before" tooltip-append-to-body="true" uib-tooltip={{"Edit Manufacture"|translate}} tooltip-class="customClass"></i></a>' +
...
app.controller('skfMultiLanguageModalCtrl', function ($scope, $http, $uibModalInstance, params, uiGridConstants, alertFactory, $timeout) {
    ...
    var _columns = [
        ...
        { name: 'ManufacturerName', displayName: 'Manufacture Name', headerCellFilter: 'translate', enableColumnResizing: true, enableCellEdit: true, enableFiltering: false, minWidth: 150 },
