...
app.controller("skfHeaderController", function ($scope, $http, languageFactory, $uibModal, clientFactory, $window, $location, $translate) {
        ...
        $http.get("/Users/GetLastSession").then(function (response) {
            if (response.data) {
                ...
                if ($scope.ClientSiteData.ClientSiteId != null) {
                    console.log($scope.ClientSiteData.ClientSiteId);
